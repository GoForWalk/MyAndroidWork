...
public class MyTwo extends AppCompatActivity implements Serializable {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int c = intent.getIntExtra("num3", 999); // "num3" 라는 이름은 없었다 (999 삽입)

        long l = intent.getLongExtra("long", 0);
        String msg = intent.getStringExtra("msg"); // 리턴값이 Object 인 경우, 디폴트 값 설정은 없다.
                                                        // name 없으면 null 리턴

...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn1 = findViewById(R.id.btn6);
        ...
        // 방법4 : implement 한 클래스 사용 // 모두 비슷한 동작을 하는것들을 묶어서 동시에 만든다.
        ...
        btnInc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d("myapp", "글꼴 사이즈" + size);
//                tvResult.setTextSize(tvResult.getTextSize() * 0.5f);
        ...
        btnDec.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View v) {
//                tvResult.setTextSize(tvResult.getTextSize() * 0.3f);
                float size = tvResult.getTextSize();
                Log.d("myapp", "글꼴 사이즈" + size);
                tvResult.setTextSize(0,size - 5);
            }
    ...
    // 방법 5: 액티비티가 implement 한 것을 사용 (1)
    @Override
    public void onClick(View v) {

        ...
        switch (id){
            case DIALOG_TEXT:
                AlertDialog.Builder builder1 =
                        new AlertDialog.Builder(this // 제어권자
                                );
            ...
            case DIALOG_LIST:
                ...
                final String[] str = {"사과", "배", "딸기", "수박"};
                builder2.setTitle("리스트 타입 다이얼로그")
                ...
                builder3.setTitle("색을 고르세요")
                        ...
                        .setPositiveButton("선택완료",
                                ...
                                new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                               Toast.makeText(getApplicationContext(), str2[choice], Toast.LENGTH_SHORT).show();
                                    }
                                })
                        .setNegativeButton("취소", null)
                        ;
                ...
                builder4.setTitle("MultiChoice 다이얼로그 제목")
                        ...
                        .setMultiChoiceItems(
                                ...
                                new DialogInterface.OnMultiChoiceClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which, boolean isChecked) {// 몇번째 체크 박스에서, 체크 여부

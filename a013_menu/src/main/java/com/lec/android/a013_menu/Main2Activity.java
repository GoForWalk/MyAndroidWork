...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivCtxView = findViewById(R.id.ivCtxView);
...
//        unregisterForContextMenu(tvCtxMenu); // 뷰객체(위젯 등) 에 등록된 ContextMenu 제거
        ...
        // #2
        registerForContextMenu(ivCtxView);
    ...
    public boolean onContextItemSelected(@NonNull MenuItem item) {
        ...
        int id = item.getItemId(); // 옵션아이템의 id 값
        ...
        switch (groupId){
            ...
            case 1:
                switch (id){
                    case 1: // 아이언맨
                        ivCtxView.setImageResource(R.drawable.face01);
                        break;
                    case 2: // 캡아
                        ivCtxView.setImageResource(R.drawable.face02);
                        break;
                    case 3: // 헐크
                        ivCtxView.setImageResource(R.drawable.face03);
                        break;
                }

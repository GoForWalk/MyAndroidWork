...
// #1 WebView 사용하여 웹 페이지 보여주기 --> 내 앱에서 보는것
// #2 묵시적 Intent 사용하여 웹 브라우져 띄우기 --> 앱 밖 브라우저 앱을 통해서 웹을 연다!!
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnWebView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                wv.setWebChromeClient(new WebChromeClient()); // 안하면 alert() 같은 알림창이 안뜸!! (popup 알림창)
